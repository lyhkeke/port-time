		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<button type="button" class="navbar-toggle collapsed"
					...
					<span class="sr-only"> 校园兼职系统 </span> <span class="icon-bar">
		...
		<div class="modal-dialog modal-sm min_width" role="document">
			...
			<div class="modal-content" id="register-main" style="display:block;">
				...
				<div class="modal-header">
					...
					<h5 class="modal-title">校园兼职系统</h5>
				</div>
				<!--注册表单-->
...
<%--					</div>--%>
					<div class="input-wrapper">
						<input type="text" placeholder="手机号" name="register_phone" id="register_phone" />
						<!--Error message-->
						<span class="animated fadeInRight register-phone-wrong register_tips" id="phoneTip">
	...
	<div class="footer">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-6 foot-l">Copyright © 2023.
					校园兼职系统 All rights reserved.</div>
				<div class="col-xs-12 col-sm-6 foot-r">
					<i class="icon-tasks"></i> 校园兼职系统
				</div>
			</div>
		</div>
	</div>
