            ...
            success: function (data) {
                ...
                if (jsonData.length > 0) {
                    ...
                    for (let i = 0; i < jsonData.length; i++) {
                        var sname = '暂无学校'
                        if(jsonData[i].school && jsonData[i].school != null){
                            sname = jsonData[i].sname
                        }
                        $("#userinfo_total").append(
                            "<tr>" +
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (jsonData.length > 0) {
                ...
                for (var i = 0; i < jsonData.length; i++) {
                    var username = '没有用户'
                    if (jsonData[i].user && jsonData[i].user != null) {
                        username = jsonData[i].user.username
                    }
                    $("#orders_total").append("<tr><th>" + username + "</th>" +
