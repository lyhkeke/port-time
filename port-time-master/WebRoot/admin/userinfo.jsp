    ...
    <div class="row box_container">
        <div class="col-sm-2 in_width" id="in_width">
            <nav class="navbar navbar-default nav_box" id="nav_box"
                ...
                <div class="ollapse navbar navbar-collapse" aria-expanded="false"
                    ...
                    <ul class="nav navbar-nav" id="LeftNav">
                        ...
                        <div class="panel  panel_active">
                            <div class="panel-heading" role="tab">
                                <a href="userinfo.jsp"> <i class="fa fa-user"
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab">
                                <a href="schoolinfo.jsp"> <i class="fa fa-graduation-cap"
                                                             aria-hidden="true"></i> 学校管理
                                </a>
                            </div>
                        </div>
        ...
        <div class="col-sm-10 col-xs-12  RightDiv">
            <div class="row">
                <div class="userinfo_table" id="userinfo_table">
                    <div class="title_head user_color clearfix">
                        <div class="revenue_head user_head_color pull-left">
                            <i class="fa fa-user" aria-hidden="true"></i>
                        </div>
                        <h3 class="pull-left">用户修改</h3>
                        <span class="pull-right"> 校园兼职系统 </span>
                        <div class="search  pull-right">
                            <i class="fa fa-search" aria-hidden="true"></i> <input
                                type="text" class="search_user" placeholder="请输入用户名搜索"
                                id="username"/>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped table-hover " id="userinfo_total">
                    </table>
                </div>
            </div>
        </div>
