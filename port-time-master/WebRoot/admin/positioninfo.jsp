	...
	<body class="skin-blue sidebar-mini sidebar-collapse">
		<div class="container-fluid headerFFF">
			<div class="row">
				...
				<div id="AlertA">
					<div class="AlertABtm">
						<i class="fa fa-key" aria-hidden="true"></i> 注销
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-sm-10 col-xs-12  RightDiv">
					<div class="row">
						<div class="school_have col-sm-12 col-xs-12">
							<div class="title_head port_color  clearfix">
							...
							<div class="school_head_all">
								<table class="table table-bordered table-striped table-hover " id="partTimeType_total">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">添加兼职种类</h4>
					</div>
					<div class="modal-body">

						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">种类:</span>
							<input type="text" class="form-control" aria-describedby="basic-addon1" name="add_position_input" placeholder="请输入类型" id="add_position_input"/>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						<button type="button" class="btn btn-primary" id="position_btn">保存</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
